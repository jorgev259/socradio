...
export declare const Header: Token.IToken<IAtomHeader>;
/**
 * Ref: https://developer.apple.com/library/archive/documentation/QuickTime/QTFF/QTFFChap1/qtff1.html#//apple_ref/doc/uid/TP40000939-CH203-38190
 */
export declare const ExtendedSize: Token.IToken<number>;
export declare const ftyp: Token.IGetToken<IAtomFtyp>;
/**
 * Token: Movie Header Atom
 */
export declare const mhdr: Token.IGetToken<IMovieHeaderAtom>;
/**
 ...
 */
export declare class MdhdAtom extends FixedLengthAtom implements Token.IGetToken<IAtomMdhd> {
    len: number;
 ...
 * Token: Movie Header Atom
 */
export declare class MvhdAtom extends FixedLengthAtom implements Token.IGetToken<IAtomMvhd> {
    len: number;
    constructor(len: number);
 ...
 */
export declare class StsdAtom implements Token.IGetToken<IAtomStsd> {
    len: number;
    constructor(len: number);
 ...
 */
export declare const SoundSampleDescriptionVersion: Token.IGetToken<ISoundSampleDescriptionVersion>;
 ...
 */
export declare const SoundSampleDescriptionV0: Token.IGetToken<ISoundSampleDescriptionV0>;
export {};
